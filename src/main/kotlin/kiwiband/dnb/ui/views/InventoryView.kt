...
class InventoryView(width: Int, height: Int) : View(width, height) {
    private val items = listOf(ItemFactory.getRandomItem(), ItemFactory.getRandomItem(), ItemFactory.getRandomItem())

    private val itemHolder = HorizontalLayout(width, height - 5)
    ...
    companion object {
        ...
        private const val ROW_HEIGHT = 5
